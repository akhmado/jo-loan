...
import NoLoansPlaceholder from "@/components/no-loans-placeholder";
  ...
  return (
    <div>
      ...
      <div className='px-4'>
        ...
        {loans.length === 0 && <NoLoansPlaceholder />}

        {!!loans.length && (
          <div>
            <Table role='table' aria-label='List of loans' className='mt-4'>
              <TableHeader>
                <TableRow>
